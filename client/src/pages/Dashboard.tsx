...
const GROUPS: Group[] = [
  {
    ...
    screens: [
      ...
      {
        route: "/buyer-journey-presentation",
        label: "Buyer Journey — Mortgage",
        description: "Four-slide walkthrough of the SA mortgage buyer journey: phases, money flow, touchpoints.",
        icon: <Presentation className="w-5 h-5" />,
        accentBg: "bg-[#3DBFAD]/10",
        accentText: "text-[#3DBFAD]",
        added: "13 May 2026",
      ...
      {
        route: "/cash-buyer-journey-presentation",
        label: "Buyer Journey — Cash",
        description: "Same shape, cash-buyer cut: shorter timeline, no bond/bank, ≈ half the touchpoints.",
        icon: <Presentation className="w-5 h-5" />,
        accentBg: "bg-[#3DBFAD]/10",
        accentText: "text-[#3DBFAD]",
        added: "15 May 2026",
      ...
      {
        route: "/persona-prd",
        label: "Persona Flows — PRD",
        description: "High-level PRD: the rails model (pull → Month 0 → push), white-label module toggles, MyHome Bundle, and all 7 persona process flows.",
      ...
      {
        route: "/renter-flow",
        label: "Renter Journey Flow",
        description: "Boxes-and-arrows process flow for the Renter persona: search → apply → lease → live → renew/exit, with the renter→buyer conversion.",
      ...
      {
        route: "/buyer-mortgage-flow",
        label: "Buyer (Mortgage) Journey Flow",
        description: "Boxes-and-arrows process flow for the mortgage Buyer: search → pre-approval → OTP → bond → register → Owner, with the MyHome Bundle pitched at bond application.",
        icon: <Workflow className="w-5 h-5" />,
        accentBg: "bg-[#3DBFAD]/10",
        accentText: "text-[#3DBFAD]",
        added: "08 Jun 2026",
      ...
      {
        route: "/persona-flows-board",
        label: "Persona Flows Board",
        description: "Both persona journeys — Renter and Buyer (Mortgage) — on one pannable canvas, stacked for side-by-side comparison.",
        icon: <Workflow className="w-5 h-5" />,
        accentBg: "bg-[#3DBFAD]/10",
        accentText: "text-[#3DBFAD]",
        added: "08 Jun 2026",
      ...
      },
      {
        route: "/buyer-journey",
        label: "Buyer Journey",
        description: "Every touchpoint in the SA property buying journey — 5 phases plus a day-by-day transfer race timeline.",
        icon: <Workflow className="w-5 h-5" />,
