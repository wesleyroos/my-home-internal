...
const nodeTypes = { step: StepNode, frame: FrameNode, bankOffers: BankOffersNode, anchor: AnchorNode };
...
const nodes: Node[] = [
  ...
  { id: "otp", type: "step", position: { x: 230, y: 75 }, data: { title: "📝 OTP signed", subtitle: "Offer captured", variant: "step" } },
...
const edges: Edge[] = [
  edge("e-buyer-otp", "buyer", "r", "otp", "l"),
  edge("e-agent-otp", "agent", "r", "otp", "l"),
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
              ...
              <h3 className="text-lg font-bold text-[#0C2340] mb-1">
                How do we get agents to sell this?
              </h3>
